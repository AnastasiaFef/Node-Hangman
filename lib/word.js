...
Word.prototype.map = function(inputLetter){
  ...
  // console.log('sending ', this.lettersArray, ' and ', inputLetter, ' to checkLetter.letter')
  console.log('letter: ', letter)
  var userInput = new Letter(inputLetter)
  var display = '';
  this.lettersArray.forEach(function(wordLetter){
    wordLetter.checkLetter(userInput);
    // console.log('comes back ', wordLetter.displayLetter());
